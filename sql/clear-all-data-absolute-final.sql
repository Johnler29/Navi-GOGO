-- ABSOLUTE FINAL clear of all data - handles ALL possible foreign key constraints
...
-- Clear stops table (this references routes)
DELETE FROM stops;  -- This was the missing piece!
...
UNION ALL
SELECT 'Stops remaining:', COUNT(*) FROM stops
UNION ALL
